...
<xsl:stylesheet version="1.0" xmlns:xsl="http://www.w3.org/1999/XSL/Transform"
	...
	<xsl:template match="/">
		<s11:Envelope >
		  <s11:Body>
		    <WsEnvoi:seq01_EnregistrerDepots xmlns:WsEnvoi="http://10.89.156.154:9081/CedreWebService/services/WSSynchronisationPDASIEnvoi/">
			<donnees>
				<xsl:choose>
			...
			</WsEnvoi:seq01_EnregistrerDepots>
		  </s11:Body>
		</s11:Envelope>	
	</xsl:template>
</xsl:stylesheet>
